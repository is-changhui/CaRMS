...
//            Date alwaysValidEndDateTime = sdf.parse("31/12/2999 23:59");
            ...
            RentalRate stdSedanWeekendPromo = new RentalRate("Standard Sedan - Weekend Promo", "Promotion", BigDecimal.valueOf(80), sdf.parse("09/12/2022 12:00"), sdf.parse("11/12/2022 00:00"), Boolean.TRUE, Boolean.FALSE);
            rentalRateSessionBeanLocal.createNewRentalRateJoinCarCategory(stdSedanWeekendPromo, standardSedanId);
            RentalRate famSedanDefault = new RentalRate("Family Sedan - Default", "Default", BigDecimal.valueOf(200), alwaysValidStartDateTime, alwaysValidEndDateTime, Boolean.TRUE, Boolean.FALSE);
            rentalRateSessionBeanLocal.createNewRentalRateJoinCarCategory(famSedanDefault, familySedanId);
            RentalRate luxSedanDefault = new RentalRate("Luxury Sedan - Default", "Default", BigDecimal.valueOf(300), alwaysValidStartDateTime, alwaysValidEndDateTime, Boolean.TRUE, Boolean.FALSE);
            rentalRateSessionBeanLocal.createNewRentalRateJoinCarCategory(luxSedanDefault, luxurySedanId);
            RentalRate luxSedanMonday = new RentalRate("Luxury Sedan - Monday", "Peak", BigDecimal.valueOf(310), sdf.parse("05/12/2022 00:00"), sdf.parse("05/12/2022 23:59"), Boolean.TRUE, Boolean.FALSE);
            rentalRateSessionBeanLocal.createNewRentalRateJoinCarCategory(luxSedanMonday, luxurySedanId);
            RentalRate luxSedanTuesday = new RentalRate("Luxury Sedan - Tuesday", "Peak", BigDecimal.valueOf(320), sdf.parse("06/12/2022 00:00"), sdf.parse("06/12/2022 23:59"), Boolean.TRUE, Boolean.FALSE);
            rentalRateSessionBeanLocal.createNewRentalRateJoinCarCategory(luxSedanTuesday, luxurySedanId);
            RentalRate luxSedanWednesday = new RentalRate("Luxury Sedan - Wednesday", "Peak", BigDecimal.valueOf(330), sdf.parse("07/12/2022 00:00"), sdf.parse("07/12/2022 23:59"), Boolean.TRUE, Boolean.FALSE);
            rentalRateSessionBeanLocal.createNewRentalRateJoinCarCategory(luxSedanWednesday, luxurySedanId);
            RentalRate luxSedanWeekdayPromo = new RentalRate("Luxury Sedan - Weekday Promo", "Promotion", BigDecimal.valueOf(250), sdf.parse("07/12/2022 12:00"), sdf.parse("08/12/2022 12:00"), Boolean.TRUE, Boolean.FALSE);
            rentalRateSessionBeanLocal.createNewRentalRateJoinCarCategory(luxSedanWeekdayPromo, luxurySedanId);
            RentalRate suvAndMinivanDefault = new RentalRate("SUV and Minivan - Default", "Default", BigDecimal.valueOf(400), alwaysValidStartDateTime, alwaysValidEndDateTime, Boolean.TRUE, Boolean.FALSE);
